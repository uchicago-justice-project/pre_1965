...
cha_projects <- st_filter(cha_projects, westside)
#Riots -------------------------------------
...
riots <- st_filter(riots, westside)
#Streets ------------------------------------
...
lines_sf <- st_sf(geometry = select_hways)
lines_sf <- st_set_crs(lines_sf, st_crs(homs)) 
select_hways <- st_filter(lines_sf, westside)
...
st_write(select_hways, "data/mst/for_paper/select_hways.geojson", append = FALSE )
st_write(riots, "data/mst/for_paper/riots.geojson", append = FALSE )
st_write(cha_projects, "data/mst/for_paper/projects.geojson", append = FALSE )
